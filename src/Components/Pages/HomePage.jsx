                        ...
                        <div className="row g-6 g-xl-14">
                            <div className="col-lg-4" data-aos="fade-up-sm" data-aos-delay="200">
                                <div className="d-flex flex-column gap-6 flex-lg-row">
                                    ...
                                    <div className="content">
                                        <h4 className="mb-4 text-white">Generates quality contents</h4>
                                        <p>
                            ...
                            <div className="col-lg-4" data-aos="fade-up-sm" data-aos-delay="250">
                                <div className="d-flex flex-column gap-6 flex-lg-row">
                                    ...
                                    <div className="content">
                                        <h4 className="mb-4 text-white">Provides Useful Suggestions</h4>
                                        <p>
                            ...
                            <div className="col-lg-4" data-aos="fade-up-sm" data-aos-delay="300">
                                <div className="d-flex flex-column gap-6 flex-lg-row">
                                    ...
                                    <div className="content">
                                        <h4 className="mb-4 text-white">Improves Products Productivity</h4>
                                        <p>
                ...
                <section className="overflow-hidden pt-20 pb-10 pt-lg-30 pb-lg-15">
                    ...
                    <div className="review-rolling-carousel-container">
                        <div className="swiper review-rolling-carousel">
                            <div className="swiper-wrapper h-auto rolling-carousel-wrapper">
                        ...
                        <div className="row g-6 pricing-table">
                            <div className="col-md-6 col-lg-4" data-aos="fade-up-sm" data-aos-delay="50">
                                <div className="pricing-card p-6 px-lg-10 py-lg-8 rounded-4 h-full bg-">
                                    ...
                                    <h1 className="display-2 fw-semibold text-white mb-0 mt-4">$00</h1>
                            ...
                            <div className="col-md-6 col-lg-4" data-aos="fade-up-sm" data-aos-delay="100">
                                <div className="pricing-card p-6 px-lg-10 py-lg-8 rounded-4 h-full bg-">
                                    ...
                                    <ul className="pricing-list d-flex flex-column gap-5 fs-lg mt-9 mb-0">
                                        <li>5 User seats</li>
                                        <li>
                                            <strong className="text-white fw-medium">50,000</strong> words per month
                                        </li>
                                        <li><strong className="text-white fw-medium">70+</strong> AI writing tools</li>
                                        <li>
                                            <strong className="text-white fw-medium">100+</strong> Copywriting tools
                                        </li>
                            ...
                            <div className="col-md-6 col-lg-4" data-aos="fade-up-sm" data-aos-delay="150">
                                <div className="pricing-card p-6 px-lg-10 py-lg-8 rounded-4 h-full bg-">
                                    ...
                                    <h1 className="display-2 fw-semibold text-white mb-0 mt-4">$119</h1>
                                    <p className="text-white lead fw-normal mt-4 mb-0">
                                        A 10X faster way to writing your professional copy
                                    </p>
                                    <a href="pricing-plan.html" className="pricing-btn btn btn-lg w-full fs-4 lh-sm mt-9 btn-dark-blue-3">Choose Plan</a>
                                    <ul className="pricing-list d-flex flex-column gap-5 fs-lg mt-9 mb-0">
                                        ...
                                        <li>
                                            <strong className="text-white fw-medium">100,000</strong> words per month
                                        </li>
                                        <li><strong className="text-white fw-medium">100+</strong> AI writing tools</li>
                                        <li>
                                            <strong className="text-white fw-medium">200+</strong> Copywriting tools
                                        </li>
                                        <li>Blog post wizard tool</li>
                                        <li>25+ languages</li>
                                    </ul>
