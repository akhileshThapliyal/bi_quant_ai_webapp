            ...
            <section className="py-10 py-lg-15 bg-striped" data-aos="fade-up-sm" data-aos-delay="50">
                <div className="container">
                    <div className="text-center">
                        <h3 className="text-white mb-2">About GenAI.</h3>
                ...
                <div className="container">
                    <div className="row align-center">
                        ...
                        <div className="col-lg-6 offset-xl-1" data-aos="fade-up-sm" data-aos-delay="100">
                            <div className="text-center">
                                <img className="img-fluid d-inline-block" src="assets/images/screens/screen-4.png" alt="" />
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-10 py-lg-15">
                <div className="container">
                    <div className="text-center mb-18">
                        <h2 className="text-white mb-0" data-aos="fade-up-sm" data-aos-delay="50">
				...
				Across Your Favorite Tools
                    ...
                    <div className="video-popup-container position-relative" data-aos="fade-up-sm" data-aos-delay="50">
                        ...
                        <a className="video-play-btn bg-primary-dark text-dark" href="https://youtu.be/OUFcCoTx8zM" data-vbtype="video" data-autoplay="true" data-maxwidth="1320px" data-overlay="rgba(23, 24, 37, 0.95)">
                        ...
                        <div className="col-lg-9">
                            <div className="text-center" data-aos="fade-up-sm" data-aos-delay="50">
                                <h1 className="text-white">
                                    <span className="text-primary-dark">GenAI.</span> is Powered by a <br className="d-none d-xl-block" />
						Dynamic Team.
                                </h1>
                            </div>
                        </div>
